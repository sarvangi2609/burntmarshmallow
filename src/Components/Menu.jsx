...
<ul>
  ...
  <li>Inflatable Bounce Houses</li>
  <li>Lawn Games</li>
  <li>Outdoor Play</li>
  <li>Outdoor Playhouses</li>
...
<ul>
  <li>Shower Curtains and Accessories
    <ul>
...
<ul>
    ...
    <ul>
      ...
      <li>Coffee and Tea:
        <ul>
          ...
          <li>Single Serve Coffee Makers</li>
          <li>French Press</li>
          <li>Tea Kettle</li>
        </ul>
      </li>
      <li>Cookware and Bakeware:
        <ul>
          <li>Cookware Sets</li>
          <li>Pots and Pans</li>
          <li>Grill Pans and Griddles</li>
    ...
    <ul>
      ...
      <li>Art
        <ul>
          <li>Framed Prints</li>
          <li>Canvas Art</li>
          <li>Framed Canvas Art</li>
          <li>Large Canvas Art</li>
          <li>Abstract Art</li>
          <li>Geometric Art</li>
          <li>Landscape Art</li>
          <li>Wall Accents</li>
      ...
      <li>Window Treatments
        <ul>
          ...
          <li>Blinds & Shades</li>
          <li>Curtain Rods and Hardware</li>
  ...
  <li>Ceiling Fans
    <ul>
      <li>Indoor Ceiling Fans</li>
      <li>Outdoor Ceiling Fans</li>
      <li>Ceiling Fan Light Kits</li>
      <li>Ceiling Fan Accessories</li>
    </ul>
  </li>
  <li>Outdoor Lighting
    <ul>
      <li>Outdoor Wall Lights</li>
      <li>Outdoor Ceiling Lights</li>
  ...
  <li>Kitchen and Bath Lighting
    <ul>
      <li>Kitchen Island Lights</li>
      <li>Under Cabinet Lights</li>
      <li>Bathroom Vanity Lights</li>
      <li>Bathroom Sconces</li>
    </ul>
  </li>
</ul>
  ...
  <li>
    <span>Small Space Living</span>
    <ul>
      <li>Sofas</li>
      <li>Daybeds</li>
      <li>Outdoor Bistro Sets</li>
      <li>Desks</li>
      <li>Chest of Drawers</li>
      <li>Bar & Kitchen Carts</li>
